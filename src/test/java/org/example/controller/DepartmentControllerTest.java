...
public class DepartmentControllerTest {
    ...
    public void testGetAllDepartments() throws Exception {
        ...
        assertEquals(2, firstDepartment.getCourses().size(), "Computer Science Department 應該有4個課程");
    ...
    public void testGetDepartmentCourses() throws Exception {
        ...
        assertEquals(2, department.getCourses().size(), "Computer Science Department 應該有4個課程");
